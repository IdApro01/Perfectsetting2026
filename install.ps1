...
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\XblGameSave" /v "Description" /t REG_SZ /d "@$env:SystemRoot\system32\XblGameSave.dll,-101" /f
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\XblGameSave" /v "DisplayName" /t REG_SZ /d "@$env:SystemRoot\system32\XblGameSave.dll,-100" /f
...
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\XblGameSave" /v "ImagePath" /t REG_EXPAND_SZ /d "$env:SystemRoot\system32\svchost.exe -k netsvcs -p" /f
...
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\XblGameSave\Parameters" /v "ServiceDll" /t REG_EXPAND_SZ /d "$env:SystemRoot\System32\XblGameSave.dll" /f
